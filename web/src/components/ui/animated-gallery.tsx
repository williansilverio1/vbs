...
export const ContainerSticky = ({ className, style, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
  return (
    <div
...
export const GalleryContainer = ({
  ...
  return (
    <motion.div
      className={cn(
        'relative grid h-full min-h-0 w-full grid-cols-3 gap-2 rounded-2xl',
        className
      )}
      style={{
        rotateX,
